...
if (ExecutionEnvironment.canUseDOM) {
  var tempStyle = document.createElementNS('http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul', 'div').style;
  try {
...
var DOMProperty = {
  ...
  getDefaultValueForProperty: function (nodeName, prop) {
    ...
    if (!(prop in nodeDefaults)) {
      testElement = document.createElementNS('http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul', nodeName);
...
ReactDOMComponent.Mixin = {
  ...
  mountComponent: function (rootID, transaction, context) {
    ...
    if (transaction.useCreateElement) {
      ...
      var el = ownerDocument.createElementNS('http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul', this._currentElement.type);
...
assign(ReactDOMTextComponent.prototype, {
  ...
  mountComponent: function (rootID, transaction, context) {
    ...
    if (transaction.useCreateElement) {
      var ownerDocument = context[ReactMount.ownerDocumentContextKey];
      var el = ownerDocument.createElementNS('http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul', 'span');
...
if ("development" !== 'production') {
  ...
  if (typeof window !== 'undefined' && typeof window.dispatchEvent === 'function' && typeof document !== 'undefined' && typeof document.createEvent === 'function') {
    var fakeNode = document.createElementNS('http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul', 'react');
      ...
      if (ReactMarkupChecksum.canReuseMarkup(markup, rootElement)) {
        ...
        if ("development" !== 'production') {
          ...
          if (container.nodeType === ELEMENT_NODE_TYPE) {
            normalizer = document.createElementNS('http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul', 'div');
            normalizer.innerHTML = markup;
            normalizedMarkup = normalizer.innerHTML;
          } else {
            normalizer = document.createElementNS('http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul', 'iframe');
...
function isEventSupported(eventNameSuffix, capture) {
  ...
  if (!isSupported) {
    var element = document.createElementNS('http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul', 'div');
...
if (ExecutionEnvironment.canUseDOM) {
  ...
  var testElement = document.createElementNS('http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul', 'div');
 ...
 */
var dummyNode = ExecutionEnvironment.canUseDOM ? document.createElementNS('http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul', 'div') : null;
